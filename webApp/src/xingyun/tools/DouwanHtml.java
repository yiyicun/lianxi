...
public class DouwanHtml {
	...
	//获取
	public String keepsession(String url, String session,String rel)
		...
		try {
			...
			//在JDK1.7客户端代码中指定使用的协议System.setProperty("https.protocols", "TLSv1.2")或
			// 创建httpget
			HttpGet httpGet = getHttpGet(url, session,rel);
			// 执行get请求.
	...
	//get设置
	public static HttpGet getHttpGet(String host,
